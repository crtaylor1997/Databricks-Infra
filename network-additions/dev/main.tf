...
resource "azurerm_virtual_network_peering" "hub_to_dev" {
  ...
  remote_virtual_network_id = data.terraform_remote_state.dev.outputs.spoke_vnet_id
...
resource "azurerm_virtual_network_peering" "dev_to_hub" {
  ...
  resource_group_name  = data.terraform_remote_state.dev.outputs.spoke_resource_group_name
  virtual_network_name = data.terraform_remote_state.dev.outputs.spoke_vnet_name
...
resource "azurerm_private_dns_zone_virtual_network_link" "databricks_dev" {
  name = "link-databricks-dev"
